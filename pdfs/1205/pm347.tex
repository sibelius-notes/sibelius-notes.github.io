...
\begin{pfno}
\begin{itemize}
\item[$\Rightarrow$] Suppose $\to$ is a function. Suppose $g\in G, h\in H$. Then $([g],[g\inv])\to [e]$. Since $g\inv \cdot gh = h\in H$ from \propref{3.37}, then $g\sim_Hgh$, then $[g]=[gh]$, and $([gh],[g\inv])\to [ghg\inv]$. Since $\to$ is a function, $[ghg\inv]=[e]$. But this means $ghg\inv \sim_H e$, i.e., $ghg\inv \in H$. Since this holds for all $g\in G, h\in H$. Hence $H\normsub G$. 
...
$G/N$ is called the \textbf{quotient of $G$ by $N$}, or a \textbf{quotient group}. 
...
\begin{ex}[projective general linear group]
...
We still need to prove \thmref{5.4}. Before we get into the proof, let's prove the following lemma:
...
With this lemma, we can dive into the proof of \thmref{5.4}:
\begin{pf}
\begin{itemize}
...
\end{itemize}
If $\psi': G/N \to K$ is another homomorphism with $\psi'\circ q=\phi$ then $\psi'\circ q=\psi\circ q$. Since $q$ is surjective, by \lemmaref{5.8}, $\psi'=\psi$. So uniqueness holds.
\end{pf}
\begin{remark}
...
\begin{ex}[$\gl_n \mathbb{K}/\SL_n \mathbb{K}$]
...
\begin{center}
	...
	% Text Node
	\draw (122,124) node [anchor=north west][inner sep=0.75pt]   [align=left] {Subgroups of $\displaystyle G$};
	% Text Node
	\draw (475,125) node [anchor=north west][inner sep=0.75pt]   [align=left] {Subgroups of $\displaystyle H$};
	% Text Node
	\draw (317,104) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle K\mapsto \phi ( K)$};
	% Text Node
	\draw (303,144) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \phi ^{-1}( K') \mapsfrom K'$};
	% Connection
	\draw    (232,128.16) -- (469,128.83) ;
	\draw [shift={(472,128.84)}, rotate = 180.16] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
	% Connection
	\draw    (472,138.84) -- (235,138.17) ;
	\draw [shift={(232,138.16)}, rotate = 360.15999999999997] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
	
	\end{tikzpicture}
\end{center}
Furthermore:
\begin{itemize}
	\item $K_1\le K_2\iff \phi(K_1)\le \phi(K_2)$
	\item $\phi(K_1\cap K_2)=\phi(K_1)\cap \phi(K_2)$
	\item $K$ is normal $\iff$ $\phi(K)$ is normal 
	\item $\phi(\inner{S})=\inner{\phi(S)}$. This holds for any homomorphisms. $\phi\inv(\inner{S}) = \inner{\phi\inv(S)}$ doesn't have to hold if $\phi$ is not isomorphism.
	\item $[G:K]=[H:\phi(K)]$
\end{itemize}
...
\begin{array}{lll}
	...
	f^{-1}(A \cup B)=f^{-1}(A) \cup f^{-1}(B) && f\left(f^{-1}(B)\right)=B \\
...
If $\phi$ is surjective, by \lemmaref{5.12}, then $\phi$ is \textit{left} inverse to $\phi\inv$. (It might not have inverse. Sometimes we use $\phi^*$.)

So $\phi\inv:\sub(H)\to \sub(G)$ is injective. Question: \textit{What's the image of $\phi\inv$ in $\sub(G)$?}
...
When we combine \lemmaref{5.12} and \lemmaref{5.13}, we get the following theorem:

\begin{thm}[Correspondence theorem]
Let $\phi:G\to H$ be a surjective homomorphism. Then there is bijection 
\begin{center}
...
%Straight Lines [id:da881715995617179] 
\draw    (219,146) -- (456.5,146) ;
\draw [shift={(459.5,146)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
%Straight Lines [id:da06649686817354183] 
\draw    (222,169) -- (459.5,169) ;
\draw [shift={(219,169)}, rotate = 0] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;

% Text Node
\draw (122,124) node [anchor=north west][inner sep=0.75pt]   [align=left] {Subgroups \\$\displaystyle K$ of $\displaystyle G$ s.t.\\$\displaystyle \ker \phi \leq K$};
% Text Node
\draw (471,135) node [anchor=north west][inner sep=0.75pt]   [align=left] {Subgroups\\$\displaystyle K'$ of $\displaystyle H$};
% Text Node
\draw (310,121) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle K\mapsto \phi ( K)$};
% Text Node
\draw (296,177) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \phi ^{-1}( K') \mapsfrom K'$};
\end{tikzpicture}
\end{center}
Furthermore, if $\ker\phi\le K,K_1,K_2\le G$ then
\begin{enumerate}[label=(\alph*)]
\item $K_1\le K_2\iff \phi(K_1)\le \phi(K_2)$
\item $\phi(K_1\cap K_2) = \phi(K_1)\cap \phi(K_2)$
\item $K$ is normal $\iff$ $\phi(K)$ is normal
...
If $N\normsub G$, then $q:G\to G/N$ is a surjection, so we have 
\begin{thm}[Correspondence theorem for quotient groups]
Let $N\normsub G$. Then there is a bijection
\begin{center}
...
% Text Node
\draw (127,137) node [anchor=north west][inner sep=0.75pt]   [align=left] {Subgroups \\$\displaystyle N\leq K\leq G$};
% Text Node
\draw (470,136) node [anchor=north west][inner sep=0.75pt]   [align=left] {Subgroups\\$\displaystyle K'$ of $\displaystyle G/N$};
% Text Node
\draw (305,121) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle K\mapsto q( K)$};
% Text Node
\draw (296,177) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle q^{-1}( K') \mapsfrom K'$};
...
\begin{enumerate}[label=(\alph*)]
\item $K_1\le K_2\iff q(K_1)\le q(K_2)$
\item $q(K_1\cap K_2) = q(K_1)\cap q(K_2)$
\item $K$ is normal $\iff$ $q(K)$ is normal
\end{enumerate}
\end{thm}

Recall from first isomorphism theorem: If $\phi:G\to H$ is a surjective homomorphism, then $G/\ker\phi\iso H$. So there is a bijection between $\sub(H)$ and $\sub(G/\ker\phi)$.
...
\begin{center}     
	...
	% Text Node
	\draw (122,149) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle K$};
	% Text Node
	\draw (342,149) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle G$};
	% Text Node
	\draw (329,241) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle G/N$};
	% Text Node
	\draw (110,242) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle K/N$};
	% Text Node
	\draw (236,136) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle i_{K}$};
	% Text Node
	\draw (106,192) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle q_{K}$};
	% Text Node
	\draw (204.73,196.69) node [anchor=north west][inner sep=0.75pt]  [rotate=-25.52] [align=left] {$\displaystyle q_{G} \circ i$};
	% Text Node
	\draw (355,191) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle q_{G}$};
	% Text Node
	\draw (200,255) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle kN\mapsto kN$};
	% Connection
	\draw    (138,158) -- (336,158) ;
	\draw [shift={(339,158)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
	% Connection
	\draw    (128.57,171) -- (128.91,235) ;
	\draw [shift={(128.93,238)}, rotate = 269.69] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
	% Connection
	\draw    (348.93,171) -- (348.59,234) ;
	\draw [shift={(348.57,237)}, rotate = 270.31] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
	% Connection
	\draw    (138,161.97) -- (323.23,239.43) ;
	\draw [shift={(326,240.59)}, rotate = 202.69] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
	% Connection
	\draw    (151,250.9) -- (323,250.12) ;
	\draw [shift={(326,250.1)}, rotate = 539.74] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
	
	\end{tikzpicture}
\end{center}

It's easy to see $\ker q_G\circ i=N$, and by first isomorphism theorem, we get an isomorphism $\psi:K/N\to \Im q\circ i_K=q(K)$ such that $\psi\circ q_K = q_G\circ i$. In other words, if $k\in K$, then $\psi(kN)=q(k)=kN$. Let's summarize this into a proposition:
...
% Text Node
\draw (122,149) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle G$};
% Text Node
\draw (342,149) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle G/N$};
% Text Node
\draw (307,242) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle ( G/N) /( K/N)$};
% Text Node
\draw (111,242) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle G/K$};
% Text Node
\draw (236,136) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle q_{1}$};
% Text Node
\draw (106,192) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle q_{3}$};
% Text Node
\draw (365,189) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle q_{2}$};
% Text Node
\draw (239,255) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \psi $};
% Connection
\draw    (139,157.5) -- (336,157.5) ;
\draw [shift={(339,157.5)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
% Connection
\draw    (129.07,170) -- (129.42,235) ;
\draw [shift={(129.43,238)}, rotate = 269.69] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
% Connection
\draw    (361.57,170) -- (361.92,235) ;
\draw [shift={(361.93,238)}, rotate = 269.69] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
% Connection
\draw    (151,250.5) -- (301,250.5) ;
\draw [shift={(304,250.5)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
...
\begin{pf}
From \lemmaref{5.23}, it is well-defined, injective. Surjective obvious.
\end{pf}
...
% Text Node
\draw (122,149) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle H$};
% Text Node
\draw (342,149) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle HK$};
% Text Node
\draw (330,242) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle HK/K$};
% Text Node
\draw (95,242) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle H/H\cap K$};
% Text Node
\draw (233,134) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle i_{H}$};
% Text Node
\draw (106,192) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle q_{1}$};
% Text Node
\draw (365,189) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle q_{2}$};
% Text Node
\draw (239,255) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \psi $};
% Connection
\draw    (140,158) -- (336,158) ;
\draw [shift={(339,158)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
% Connection
\draw    (129.57,171) -- (129.91,235) ;
\draw [shift={(129.93,238)}, rotate = 269.69] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
% Connection
\draw    (355.43,171) -- (355.09,235) ;
\draw [shift={(355.07,238)}, rotate = 270.31] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
% Connection
\draw    (168,251) -- (324,251) ;
\draw [shift={(327,251)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;

\end{tikzpicture}
\end{center}

\begin{pf}
Already shown $HK\le G,K\normsub HK, H\cap K\normsub H$.

If $h\in H,k\in K$, then $hkK=hK$. So $HK/K=\{gK:g\in HK\}=\{hK:h\in H\}$. Hence $\Im q_2\circ i_H= \{hK:h\in H\}= HK/K$.

$\ker q_2\circ i_H = i_H\inv (q_2\inv (\{e\})) = i_H\inv (K)=H\cap K$

By the first isomorphism theorem, there is an isomorphism $\psi$ as desired.
\end{pf}


\begin{ex}[$\operatorname{PGL}_n \mathbb{C}$]
