...
can still identify some very diffiult problems--problems that are even more difficult than
the NP-complete problems we have seen already.

One particularly notable dicult problem is TQBF, which stands for "Totally Quantied
Boolean Formula".
...
These problems show that there is a wide variety of dierent diculties for computational
