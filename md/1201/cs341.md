...
By taking the complement, we can prove &#92;(\textsc{Clique} \le_P \textsc{IndepSet} &#92;) and &#92;(\textsc{Clique}\le_P \textsc{IndepSet} &#92;).

By finding a clique of size 2, &#92;(\textsc{NonEmpty} \le_P \textsc{Clique} &#92;). However, &#92;(\textsc{Clique} \le_P \textsc{NonEmpty} &#92;)? is an open question that is in fact equivalent to the famous P vs. NP problem.

Consider polynomial-time algorithm &#92;(F &#92;) that transforms the input &#92;((G,k) &#92;) to &#92;(\textsc{IndepSet} &#92;) into the input &#92;((G,n-k) &#92;) to &#92;(\textsc{VertexCover} &#92;). Then we can prove that &#92;(\textsc{IndepSet} \le_P \textsc{VertexCover} &#92;).
...
Then &#92;(\textsc{VertexCover} \le_P \textsc{SetCover} &#92;). This proof is interesting... So we for each vertex &#92;(v\in V &#92;) we create the set
&#92;[
...
<div class="fancy-block-content">
    If &#92;(A,B &#92;) and &#92;(C &#92;) are decisition problems that satisfy &#92;(A\le_P B &#92;) and &#92;(B\le_P C &#92;), then &#92;(A\le_P C &#92;).
</div></div>
Thus we can have a chain
&#92;\textsc{Clique} \le_P \textsc{IndepSet} \le_P \textsc{VertexCover} \le_P \textsc{SetCover} &#92;]
...
<div class="fancy-block-content">
denotes the set of all decision problems that
have polynomial-time certicate verication algorithms solving them. We
...
> <p>All certificates in CO250 are in terms of the original data, so when our algorithm returns an answer it also returns a certificate (in terms of the original data); this allows the "user" (who fed the input to the algorithm) to verify the algorithm's answer (without trusting the working of the algorithm).</p>
<p>This is a seemingly small idea, but in fact, it is fundamental to subjects such as optimization, NP-completeness, cryptography, etc. Let us try to see some practical consequences of this idea:</p>
