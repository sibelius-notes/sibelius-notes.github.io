...
<pre id="backtracking" style="display:hidden;">
    % This quicksort algorithm is extracted from Chapter 7, Introduction to Algorithms (3rd edition)
    \begin{algorithm}
    \caption{Backtracking}
    \begin{algorithmic}
    \STATE Initialized the set &#92;(\mathcal A &#92;) of active configurations
    \WHILE{ &#92;(\mathcal A\ne \emptyset &#92;)}
        \STATE &#92;(C\gets &#92;) next configuration of &#92;(\mathcal A &#92;)
        \IF{&#92;(C &#92;) is a solution}
            \RETURN True
        \IF{&#92;(C &#92;) is not a dead end}
            \STATE Expand(\&#92;(C &#92;)) and add the result configurations to &#92;(\mathcal A &#92;)
    \ENDWHILE
    \RETURN False
    \end{algorithmic}
    \end{algorithm}
...
<script>
    pseudocode.renderElement(document.getElementById("backtracking"));
</script>
