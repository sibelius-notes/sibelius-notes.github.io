...
In Bayesian RL, idea: augment state with distribution about unknown parameters
    - Information states: <span>&#92;((\bm s, \bm b \in \bm S\times B) &#92;)</span>
        - Physical states: <span>&#92;(\bm s\in \bm S &#92;)</span>
        - Belief states: \<span>&#92;(\bm b\in \bm B &#92;)</span> where $<span>&#92;(b(\theta) = Pr(\theta) &#92;)</span>
