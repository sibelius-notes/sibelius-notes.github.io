...
![](/pics/gradient-q-learning.png)

Historically, there was just one network, and we didn't use <span>&#92;(\bar{\bf w} &#92;)</span>. It sometimes works, sometimes diverges. Now we use two networks, one for main estimate, one for target. Keep target network fixed and simply update the other network, then it will get rid of the problem.
