...
- Target: <span>&#92;(r+\gamma \max_ {a'} Q _ {\bar{\bf w}}(s', a') &#92;)</span>

Squared error:
<span>&#92;[
    Err({\bf w}) = {1\over 2} \left[Q_ {\bf w}(s, a) -r - \gamma \max_ {a'} Q_ {\bar {\bf w}} (s', a') \right]^2
&#92;]</span>

where <span>&#92;(\bar {\bf w} &#92;)</span> is fixed.

Gradient:
<span>&#92;[
    {\partial Err \partial {\bf w}} = \left[ Q_ {\bf w}(s, a) - r - \gamma \max_ {a'} Q_ { \bar {\bf w}} (s', a')\right] {\partial Q_ {\bf w}(s,a)\over \partial {\bf w}}
&#92;]</span>
