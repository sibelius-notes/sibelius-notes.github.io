...
\begin{tabular}{|c | c | l |}
	...
	20 fall & 4b & AM 351 \quad CO 450 \quad  \tikz[baseline]{\node[anchor=base] (a) {AM 390}; } \quad MU 370 \quad PM 347 \quad PM 433\\
	21 winter & 4b & CO 444 \quad PM 348   \quad MU 371   \quad CS 365\\
	21 spring & wt4 &  CO 446 \\
	21 fall & 4b & CO 442  \quad AM 453 \quad CS 466 \quad MU 376 \quad SPCOM 223 \quad  \tikz[baseline]{\node[anchor=base] (d) {MU 275/AM 477}; } \\
	22 winter & 4b & CS 485 \quad CS 492 \quad PM 464 \quad PM 446  \\
	22 spring & wt5 & PSYCH 256\\
	22 fall & 4b & \tikz[baseline]{\node[anchor=base] (b) {CO 456}; } \quad MU 390 (Orch', Arr') \quad \tikz[baseline]{ \node[anchor=base] (c) {MU 231};} \quad PM 445 \quad CS 486 \\
 \hline

\end{tabular}

\begin{tikzpicture}[overlay]
\path[semithick, <->, dotted, color=purple] (a) edge [bend left] (b);
\path[thick,dashed,color=red, ->] (c) edge [out=60,in=30] (a);
